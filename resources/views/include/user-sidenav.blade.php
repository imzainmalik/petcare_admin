        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-examples">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/examples/login.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/examples/register.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/examples/lock.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> L </span>
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/examples/timeline.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/examples/profile.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> P </span>
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/examples/rtl-support.html"
                                        class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-components">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/components/cards.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/components/grid.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/components/notifications.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/components/icons.html"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/components/typography.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> T </span>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-forms">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/forms/components.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> C </span>
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/forms/validation.html"
                                        class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-tables">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/tables/tables.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> T </span>
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/tables/sortable.html"
                                        class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-maps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/maps/google.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> G </span>
                                ...
                                <li class="nav-item">
                                    <a href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/maps/vector.html"
                                        class="nav-link">
                                        <span class="sidenav-mini-icon"> V </span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/widgets.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/charts.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/pages/calendar.html">
                ...
                <ul class="navbar-nav mb-md-3">
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/docs/getting-started/overview.html"
                            target="_blank">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/docs/foundation/colors.html"
                            target="_blank">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/docs/components/alerts.html"
                            target="_blank">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://demos.creative-tim.com/argon-dashboard-pro-bs4/docs/plugins/charts.html"
                            target="_blank">
